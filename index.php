		...
		<div class="about">
			...
			<div class="about_blok">
				<div class="about_blok__item"><img src="img/1.png" height="80px;">
					<div class="about_blok__itext" style="text-align: center;"><div style="font-size:1.5em;margin-bottom: 10px;">Web Design</div>
					С большой ответственностью отношусь к созданию веб дизайна .
				</div>
				</div>
				<div class="about_blok__item"><img src="img/2.png" height="80px;">
					<div class="about_blok__itext" style="text-align: center;"><div style="font-size:1.5em;margin-bottom: 10px;">Development</div>Затем идет процесс верстания сайта .</div>
				</div>
				<div class="about_blok__item"><img src="img/3.png" height="80px;">
					<div class="about_blok__itext" style="text-align: center;"><div style="font-size:1.5em;margin-bottom: 10px;">Inf. Sec</div>После написания кода проверяю его на уязвимости .</div>
				</div>
				<div class="about_blok__item"><img src="img/4.jpg" height="80px;">
					<div class="about_blok__itext" style="text-align: center;"><div style="font-size:1.5em;margin-bottom: 10px;">Marketing</div>После того как я убедился в исправности проекта запускаю его в продакшн</div>
				</div>
			</div>
		</div>
		<div class="container">
